...
%For example, there are not many exercises in this book that are similar to the AP questions.
...
{\tt cout} er sérstakur hlutur (e. object), innbyggður í C++, sem gerir þér kleift að senda tiltekið úttak á skjáinn.
