...
Málskipan fyrir tagmótun er eins og málsipan fyrir fallakall.
Dæmi:
...
Fyrst reiknar þú út gildi segðar innan sviga en það eru kalluð {\bf viðfang} (e. argument} fallsins.
...
C++ býður upp á mengi af innbyggðum (e. built-in) föllum sem innihalda flestar þær stærðfræðilegu aðgeðir sem þú getur ímyndað þér.
