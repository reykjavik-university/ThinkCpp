...
\usepackage{epsfig}
\usepackage{makeidx}
%\usepackage[xindy={language=icelandic, codepage=utf8}, style=altlist]{glossaries}
%\usepackage[xindy, splitindex]{imakeidx}
\usepackage{url}
\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage[icelandic]{babel}
%\def\xindylangopt{-M lang/icelandic/utf8-lang}
\pssilent
...
sam-þjappaðri samþjapp-aðri setning-arnar setninga-fræðilega setning-ar skap-andi skil-yrði skil-yrðissetningar skilyrðis-setningar stærðfræð-ingar 
tilrauna-gildum
